...
### 1. The GIFT Field Equation
Visualizes the non-linear relationship between homeostatic drive and the "depth" of the energy well. It illustrates the geometric transition from **Waking Presence** to the **Phenomenal Snap**.



### 2. Manifold Deformation
A 3D simulation showing how the "predictive grip" on reality is physically instantiated as the curvature of the inferential manifold.
